...
namespace LibraryManagement
{
    public partial class ViewBooks : Form
    {
        ...
        private void ViewBooks_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from MaxBook";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmd.CommandText = "select * from MaxBook where bid= " + bid + "";
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            da.Fill(ds);
        ...
        private void txtBookName_TextChanged(object sender, EventArgs e)
        {
            if (txtBookName.Text != "")
            {
                ...
                cmd.CommandText = "select * from MaxBook where bName LIKE '" + txtBookName.Text + "%'";
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                da.Fill(ds);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Data will be Updated. Confirm?", "Succes", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
                cmd.CommandText = "update MaxBook set bName= '" + bname + "',bAuthor ='" + bauthor + "',bPubl='" + publication + "',bPDate='" + pdate + "',bPrice=" + price + " ,bQuan=" + quan + " where bid =" + bid + "";
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                da.Fill(ds);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Data will be Deleted. Confirm?", "Succes", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning) == DialogResult.OK)
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
                cmd.CommandText = "delete from MaxBook where bid =" + rowID + "";
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                da.Fill(ds);
                ViewBooks_Load(this, null);
